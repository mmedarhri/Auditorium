...
public class JDOHbaseUser {
	...
	public User getUserByLogin(String login) {
		...
		try {
			...
			while (iter.hasNext()) {
				...
				userobtenu = new User(user.getLogin(), user.getPassword(), user.getRole());
				return userobtenu;
			}
	...
	public User getUser(String login, String password) {
		...
		try {
			tx.begin();
			System.out.println("Recupere le user ayant le login " + login+ " && password : "+password);
			@SuppressWarnings("rawtypes")
			Extent e = pm.getExtent(User.class, true);
			Query query = pm.newQuery(e, "login==" + "'" + login
					+ "' && password==" + "'" + password + "'");
...
*/
		//User mm = jdohb.getUser("mm", "essaim");
		User mm = jdohb.getUser("mm","essaim");
