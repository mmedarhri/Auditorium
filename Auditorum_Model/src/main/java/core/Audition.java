...
public class Audition {
	...
	public String toString() {
		return "Audition"+"\n"+"[ Audition de " + candidat.getProprietes().getTitre()
				...
				+ "\ndébut de l'audition à " + heure_debut + "h" + minutes_debut
				+ "\nfin de l'audition à " + heure_fin + "h" + minutes_fin + "\n]";
	}

	@SuppressWarnings("deprecation")
	public static void main(String[] args) {
		
		GregorianCalendar date_debut = new GregorianCalendar(2010, 9, 22);
		GregorianCalendar date_fin = new GregorianCalendar(2010, 10, 22);

		Demi_Journee dj1 = new Demi_Journee(date_debut, 1);
		Demi_Journee dj2 = new Demi_Journee(date_debut, 2);
		
		dj1.setDebut(8, 45);

		Propriete candidat1 = new Propriete(Propriete.Monsieur, "medarhri",
				"mohamed", "m.medarhri@gmail.com", "0617115650");
		Propriete candidat2 = new Propriete(Propriete.Mademoiselle, "AYGUN",
				"MERVE", "m.aygun@gmail.com", "0617115650");
