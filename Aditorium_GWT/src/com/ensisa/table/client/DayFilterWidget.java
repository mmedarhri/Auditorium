...
public class DayFilterWidget extends Composite {
  ...
  public DayFilterWidget(SchoolCalendarWidget calendar) {
    ...
    outer.add(new DayCheckBox("Monday", 0));
    outer.add(new DayCheckBox("Tuesday", 1));
    outer.add(new DayCheckBox("Wednesday", 2));
    outer.add(new DayCheckBox("Thursday", 3));
    outer.add(new DayCheckBox("Friday", 4));
